...
<body class="hold-transition sidebar-mini">
    ...
    <nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown dropdown-notifications" >
                <a class="nav-link" data-toggle="dropdown" href="#" onclick="markAsRead()">
                    <i class="fa fa-bell-o"  ></i>
                    <span class="badge badge-warning navbar-badge" data-count="1">{{count(auth()->user()->unreadNotifications)}}</span>
                </a>
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right" id="notiff">
        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <button class="btn" onclick="testAppend()"> Haii </button>
                    </li> 
                    @endif
    ...
    <script>
        ...
        function testAppend()
        {
            $("#notiff").append('<a class="text-center"> Byeee </a>');
        }
    </script>
