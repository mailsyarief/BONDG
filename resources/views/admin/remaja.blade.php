                                    ...
                                    <table id="example1" class="table table-bordered table-striped" >
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{str_pad($data->nodg, 8, '0', STR_PAD_LEFT)}}  </td>
                                                <td>{{$data->namapel}}</td>
                                                <td>{{$data->idpel}}</td>
                                                <td>{{$data->petugas->name}}</td>
                                                <td class="text-center">{{$data->status}} <br>                                           
                                                    <button type="button"class=" btn btn-sm btn-primary" onclick="window.location.href = '{{ url('foto-berita-acara/' . str_pad($data->nodg, 8, '0', STR_PAD_LEFT)) }}'"> Lihat Foto Berita Acara </button>
                                                </td>
